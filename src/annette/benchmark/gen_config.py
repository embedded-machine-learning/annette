...
def guess_runtime(config_points, time_per_config = 1):
    print(f'AiWare guessed benchmark time: {time_per_config * config_points / 60 / 60} hours.')
...
if __name__ == '__main__':
    ...
    print(config)
    config.to_csv(get_database('benchmarks', 'config', 'config_v7_3.csv'), index=False)
