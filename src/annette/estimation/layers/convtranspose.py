...
class ConvTransposeLayer(BaseLayer):
    ...
    def compute_nums(layer):
        """Compute Num Parameters for ConvolutionTranspose Layer prediction"""
    ...
    def compute_parameters(self, layer = None):
        """Compute Parameters for ConvolutionTranspose Layer prediction"""
        ...
        self.layer['num_inputs'] = reduce(lambda x, y: x*y, self.layer['input_shape'][1:])
