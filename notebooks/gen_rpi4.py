...
rpi4 = HardwareModelGen("rpi4-stat")
rpi4.add_layer("conv", "Conv", "statistical", data = get_database('benchmarks', 'rpi4', 'annette_bench5', 'Conv.p'),
    #sweep_data = get_database('benchmarks', 'ov_cpu', 'annette_bench0', 'Conv.p'),
    est_dict = conv_est_dict)
rpi4.add_layer("conv", "DepthwiseConv", "statistical", data = get_database('benchmarks', 'rpi4', 'annette_bench5', 'DepthwiseConv.p'),
    #sweep_data = get_database('benchmarks', 'ov_cpu', 'annette_bench0', 'Conv.p'),
    est_dict = conv_est_dict)
